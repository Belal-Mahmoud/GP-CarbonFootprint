...
// The following is a middleware that will execute the "Mounting Router" which is using "dataRouter" router instead of using "app.use" router.
app.use(`${route}/users`, userRouter);
app.use(`${route}/data`, dataRouter);
app.use(`${route}/results`, resultRouter);
